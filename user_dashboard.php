  ...
  <body style="background:gray;">
    ...
    <div class="row">
      <div class="col-md-2 m-auto">
        ...
        <a href="" type="button" class="btn btn-primary btn-block"><form>
        <script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_LI2cVDH06u1f73" async> </script> </form></a>
